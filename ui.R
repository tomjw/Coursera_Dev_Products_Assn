...
shinyUI(fluidPage(
        ...
        titlePanel("Determine Hubble constant from Galaxy Data"),
        ...
        sidebarLayout(position = "right",
                ...
                mainPanel(p('This application uses the distance and recession velocity for 8315 galaxies, compiled by Tulley et al. (2013). 
